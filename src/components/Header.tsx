...
const Header = ({isSearch, onClicks, setIsSearch}: Props) => {
    ...
    <>
      ...
      <header className='py-[8px] h-[57px] sticky top-0 z-10 bg-white lg:h-[64px] mt-[0.1px]'>
        <div className="flex text-center justify-center h-[100%] px-[15px] pc:px-[48px]">
          ...
          {/* <div className=" fixed p-[15px] top-0 bg-white min-h-[100%] w-[100%] z-30 lg:p-0 lg:min-h-[584px]">
            <div className="max-w-[900px] m-[0_auto] py-[56px] relative">
                ...
                <div className="">
                    ...
                    <form action="" className="relative">
                        ...
                        <Link to={`/search?name=`} className="bg-transparent absolute bottom-[10px] right-[15px] w-[32px] h-[32px] flex items-center justify-center">
